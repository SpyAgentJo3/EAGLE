...
\begin{titlepage}
	...
	\begin{figure}[!h]
		\subfigure{\includegraphics[height=1.75cm]{THM-logo-eps-converted-to.pdf}}
        \hspace{0.5cm}
		\subfigure{\includegraphics[height=2.5cm]{sprog-logo-discord.png}}
    \end{figure}
    \end{center}
...
\section{State machines} \label{sec:state_machine}
...
\begin{figure}[H]
	\centering
	\captionsetup{font=footnotesize}
	\subfigure[Top view]{\includegraphics[width=0.48\textwidth]{PCB-conccept-top.pdf}}
	\hfill
	\subfigure[Bottom view]{\includegraphics[width=0.48\textwidth]{PCB-conccept-bottom.pdf}}
	\caption{PCB concept}
...
\begin{center}
	\captionof{table}{Inertial Measurement Unit(IMU) characteristics}	
	...
	\begin{adjustbox}{width=1.15\textwidth}		 
		\begin{tabular}{|r||c|c|c|c|c||c|c|c|c|} \hline		
			...
			\rowcolor{light grey} $Gyro Specs$ & \multicolumn{5}{c||}{} & \multicolumn{4}{c|}{} \\ \hline\hline
			...
			\makecell{\textbf{Sensitivity Change}\\\textbf{Due to temperature}} & \multicolumn{5}{c||}{$\pm0.02\,\frac{\%}{°\text{C}}$} & \multicolumn{4}{c|}{$\pm3\,\%$\tablefootnote{maximum absolute offset}} \\ \hline
